package com.bdqn.itrip.exception;
...
public class GlobalExceptionHandler {
    ...
    public Object handleException(HttpServletRequest request, Exception e) throws Exception {
        ...
        if (e instanceof BusinessExcpetion) {//如果异常的类型属于业务异常，则返回业务异常信息（代码+文字）
            ...
            resposeData.put("errCode", EnumBusinessError.UNKNOWN_ERROR.getErrorCode());
            resposeData.put("errMsg", EnumBusinessError.UNKNOWN_ERROR.getErrMsg());
